...
export const handleComponent = (value) => (dispatch) =>
  dispatch({ type: "HANDLE_COMPONENT", value });

export const handleMenulist = (value) => (dispatch) => dispatch({ type: "HANDLE_MENULIST", value });

export const handleSubmenulist = (value) => (dispatch) =>
  dispatch({ type: "HANDLE_SUBMENULIST", value });

export const handleBehavior = (value) => (dispatch) => dispatch({ type: "HANDLE_BEHAVIOR", value });

export const handleHovertext = (value) => (dispatch) =>
  dispatch({ type: "HANDLE_HOVERTEXT", value });
...
export const handleRightclick = (value) => (dispatch) =>
  dispatch({ type: "HANDLE_RIGHTCLICK", value });
